...
#include "SakoSpindleControl.h"
#include "gpio.h"
#include "Modbus.h"

void SakoSpindleControl::turn_on()
{
...
void SakoSpindleControl::turn_off()
{
    // prepare data for the spindle off command
...
void SakoSpindleControl::set_speed(int target_rpm)
{
...
void SakoSpindleControl::report_speed()
{
